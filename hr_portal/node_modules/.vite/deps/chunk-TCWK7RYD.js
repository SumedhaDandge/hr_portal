import {
  ...
  utcTime,
  wiggle_default
} from "./chunk-44GLAWL4.js";
import {
  Typography_default
} from "./chunk-VP3LOFLD.js";
import {
  useTheme
} from "./chunk-HZHEVYRI.js";
import {
  shouldForwardProp
} from "./chunk-JL7VMJ6R.js";
import {
  require_react_dom
...
} from "./chunk-AVDDEIK4.js";
import {
  _extends,
  _objectWithoutPropertiesLoose,
  clsx_default,
  init_extends
} from "./chunk-BMSDDMEC.js";
import {
  require_prop_types
...
function useSeries() {
  const {
    isInitialized,
    data
  } = React4.useContext(SeriesContext);
  if (!isInitialized) {
...
function CartesianContextProvider(props) {
  ...
  const xAxis = React9.useMemo(() => normalizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React9.useMemo(() => normalizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  const xValues = React9.useMemo(() => computeValue(drawingArea, formattedSeries, xAxis, xExtremumGetters, "x"), [drawingArea, formattedSeries, xAxis, xExtremumGetters]);
  const yValues = React9.useMemo(() => computeValue(drawingArea, formattedSeries, yAxis, yExtremumGetters, "y"), [drawingArea, formattedSeries, yAxis, yExtremumGetters]);
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React17.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React18.createElement(Provider, { value: props }, children);
};
...
function InteractionProvider(props) {
  ...
  return (0, import_jsx_runtime6.jsx)(InteractionContext.Provider, {
    value,
    children
  });
}
...
var ColorContext = React20.createContext({});
if (true) {
...
function ColorProvider(props) {
  ...
  return (0, import_jsx_runtime7.jsx)(ColorContext.Provider, {
...
var ChartsSurface = React23.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width,
    height,
...
function useColorProcessor(seriesType) {
  const colorProcessors = React42.useContext(ColorContext);
  if (!seriesType) {
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types14.default.shape({
    ...
    getColor: import_prop_types14.default.func,
    ...
    series: import_prop_types14.default.object,
      ...
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime23.jsx)("thead", {
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime23.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime23.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color && (0, import_jsx_runtime23.jsx)(ChartsTooltipMark, {
                color,
                className: classes.mark
              })
            }), (0, import_jsx_runtime23.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime23.jsx)(Typography_default, {
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types16.default.shape({
    axis: import_prop_types16.default.object,
    axisData: import_prop_types16.default.shape({
      x: import_prop_types16.default.shape({
        index: import_prop_types16.default.number,
        value: import_prop_types16.default.oneOfType([import_prop_types16.default.instanceOf(Date), import_prop_types16.default.number, import_prop_types16.default.string]).isRequired
...
function DefaultChartsLegend(props) {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React47.useMemo(() => {
    let x = 0;
    let y = 0;
...
true ? DefaultChartsLegend.propTypes = {
  ...
  drawingArea: import_prop_types18.default.shape({
    bottom: import_prop_types18.default.number.isRequired,
    height: import_prop_types18.default.number.isRequired,
    left: import_prop_types18.default.number.isRequired,
    right: import_prop_types18.default.number.isRequired,
  ...
  seriesToDisplay: import_prop_types18.default.arrayOf(import_prop_types18.default.shape({
...
//# sourceMappingURL=chunk-TCWK7RYD.js.map
