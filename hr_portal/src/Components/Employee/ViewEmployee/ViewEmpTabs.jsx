...
import EmpPersonalInformation from "./EmpPersonalForm.jsx";
import EmpProfessionalInformation from "./EmpProfessionalForm.jsx";
...
const AddCandidate = () => {
  ...
  return (
    <Box sx={{ width: "100%" }}>
      ...
      >
        {value === "one" && <EmpPersonalInformation />}
         {value === "two" && <EmpProfessionalInformation/>}
