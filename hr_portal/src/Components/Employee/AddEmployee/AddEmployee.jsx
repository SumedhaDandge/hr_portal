...
import AddEmpPersonalForm from "./AddEmpPersonalForm.jsx";
import AddEmpProfessionalForm from "./AddEmpProfessionalForm.jsx";
...
const AddCandidate = () => {
  ...
  return (
    <Box sx={{  width: "95%", background:"var(--white)", margin:"10px", padding:"10px" }}>
      ...
      >
        {value === "one" && <AddEmpPersonalForm/>}
        {value === "two" && <AddEmpProfessionalForm />}
