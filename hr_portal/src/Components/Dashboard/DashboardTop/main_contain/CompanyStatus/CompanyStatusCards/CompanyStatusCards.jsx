                        ...
                        <div key={index} className="card-container border">
                            ...
                            <div className="card-body flex flex-col gap-y-2">
                                <div className="card_info flex justify-between">
                                    <button className='text-sm rounded-lg shared'>{d.btn1}</button>
                                    <h1>5</h1>
                                </div>
                                <div className="card_info flex justify-between">
                                    <button className='text-sm rounded-lg interview'>{d.btn2}</button>
                                    <h1>5</h1>
                                </div>
                                <div className="card_info flex justify-between">
                                    <button className='text-sm rounded-lg selected'>{d.btn3}</button>
                                    <h1>5</h1>
                                </div>
                            </div>
                        </div>
